...
1. **Create an Instance Secret manifest file**Create an Instance Secret to securely store the database connection credentials of PostgreSQL:
...
3. **Apply the Instance Secret using DataOS CLI**
...
5. **Refer to the Instance Secret in the Depot Manifest**
