...
1. **Enhanced Security**
    ...
    – Credentials are stored securely instead of being exposed in YAML files of other Resources.

2. **Centralized Management**

    – Changes to credentials are made in one place without modifying multiple manifests.

3. **Access Control**

    – Only authorized users and services can retrieve secrets.