...
sidebarTitle: "Instance Secret usage"
...
1. **Ensure Creation of Instance-Secret:**

    First, make sure you have created the respective Instance Secrets.

2. **Use `secrets` Identifier:**

    In the Depot manifest, use the 
...
1. **Ensure Creation of Instance-Secret:**
    ...
    First, make sure you have created the respective Instance Secrets for your Service.

2. **Use `secrets` Identifier:**

    In the Service manifest, use the 
