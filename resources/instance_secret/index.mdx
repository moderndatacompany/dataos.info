...
&#x20;This section includes steps for creating the Instance Secret to secure credentials of commonly used data sources and hosted code repositories. A DataOS Operator is generally responsible for creating an Instance Secret.
...
<AccordionGroup>
  ...
  <Accordion title="Simple Storage Service (Amazon S3)" defaultOpen={false}>
    ...
    * **Tags:** An operator must possess the following tags, which can be obtained from a DataOS administrator.
    ...
    * **Use cases:** A developer can create an Instance Secret only if an operator assigns them the "Manage All Instance-level Resources of DataOS in the user layer" use case using Bifrost Governance. Alternatively an operator can assign the `data-dev` tag to a developer instead of assigning a use case.
...
<AccordionGroup>
  ...
  <Accordion title="Bitbucket" defaultOpen={false}>
    ...
    * **GITSYNC_USERNAME**
      ...
      : This represents the Bitbucket username required for authentication.

    * **GITSYNC_PASSWORD**

      : This is the corresponding password or an app password used for authentication.
  ...
  <Accordion title="Git" defaultOpen={false}>
    ...
    * **GITSYNC_USERNAME**
      ...
      : This represents the Git username required for authentication.

    * **GITSYNC_PASSWORD**

      : This is the corresponding password used for authentication.
      These credentials can be obtained from the Bitbucket account settings or provided by an administrator.
