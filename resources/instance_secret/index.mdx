...
If you want to store credentials for various data sources in an Instance Secret follow the steps given below.
...
<AccordionGroup>
  <Accordion title="Azure Blob File System Secure (ABFSS)" defaultOpen={false}>
    ...
    * **Manage All Instance-level Resources of DataOS in User Layer**
    ...
    <Frame as="div">
      ![](/resources/instance_secret/images/usecase2.png)
    </Frame>
