...
Operators can exercise precise control over who can retrieve credentials from Secrets. If any data developer in your organization needs access to secrets, you can assign them a 'read instance secret' use case using Bifrost. An Instance Secret stores the credentials in the Heimdall storage vault.
...
<AccordionGroup>
  ...
  <Accordion title="Container Registry" defaultOpen={false} />
</AccordionGroup>
