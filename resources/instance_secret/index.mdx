...
![](/instance_secret_manifest_structure.jpg)
...
Once an Instance Secret is successfully created, you can view its metadata in the Metis UI. Additionally, any updates made to an Instance Secret can be tracked in the Metis's activity section.
