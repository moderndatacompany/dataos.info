...
The structure of the Instance Secret manifest file is outlined as follows:![image](/is_struc.jpg)
...
<AccordionGroup>
  ...
  <Accordion title="Google Cloud Storage (GCS)" defaultOpen={false}>
    ...
    * `data`: Contains sensitive information such as Azure endpoint suffix, storage account key, and storage account name.
    ...
    For more information, refer to the [Attributes of Instance-secret specific section](https://example.com/c/678f3bec-7128-8002-ab9b-3a112795db86#).
  ...
  <Accordion title="Microsoft SQL Server (MSSQL) or Azure SQL" defaultOpen={false}>
    ### **Pre-requisites**
...
<AccordionGroup>
  <Accordion title="AWS CodeCommit" defaultOpen={false}>
    ...
    * **GITSYNC_USERNAME**
      ...
      : This represents the AWS CodeCommit username required for authentication.
