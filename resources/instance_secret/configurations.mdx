...
The Instance Secret manifest comprises a Resource meta section that outlines essential metadata attributes applicable to all Resource types. Note that within this section some attributes are optional, while others are mandatory. For more information about the various attributes in the Resource meta section, refer to the [Attributes of Resource meta section](https://dataos.info/resources/manifest_attributes/).
