...
* Simply navigate to 
  ...
  `Resources → Depots`
   ...
   to check the status of any Depot within the environment. Additionally, users can quickly find a specific Depot by searching for its name in the Metis UI search bar.

<Frame caption="Metis UI">
  ![](/resources/depot/depot_list_metis.png)
</Frame>

* ![](/Screenshotfrom2025-02-1215-58-43.png)
  ...
  ![](/Screenshotfrom2025-02-1216-04-38.png)
...
![](/Screenshotfrom2025-01-2913-09-50.png)![](/Screenshotfrom2025-02-1215-47-50.png)
...
1. Open the **Operations** app.
   ...
   ![](/Screenshotfrom2025-02-1216-23-42.png)

3. Navigate to the User Space tab and go to the Resources section.

4. Select Depot as the Resource type to filter all Depots in the environment.

   j

   ![](/Screenshotfrom2025-02-1216-24-33.png)

5. Search for or select the target Depot.

6. Monitor its status, including Cloud Kernel Resource Count, WebService Resource Count, Operator Runtime Resource Count, Builder Stage, and Runtime Status.

   j

   ![](/Screenshotfrom2025-02-1216-25-30.png)
...
1. Go to the **Core Kernel** section in the **Operations** app.
   ...
   ![](/Screenshotfrom2025-02-1216-46-19.png)

2. In the Pods tab, search for Depot to view all related pods.

     j

   ![](/Screenshotfrom2025-02-1216-47-33.png)

4. Select a pod from the list.

5. Clicking on the pod will open a right-side panel with four sections: Pod Details, Pod Logs, Pod YAML, and Pod Usage.

   j

   ![](/Screenshotfrom2025-02-1216-48-45.png)

6. Pod details include:
   ...
   * **Conditions**
     ...
     * `PodScheduled`
       ...
       **True**
       ...
       indicates the pod is successfully running and fully operational.)
   ...
   * **Container Status**
     ...
     * **Started At:**
       ...
       `2025-02-10T16:46:00Z`

     * **Events**

       (No events are currently displayed, but this section would normally show logs related to the pod's lifecycle, errors, or warnings.)

7. Pod YAML contains the manifest file of the Pod.j

   ![](/Screenshotfrom2025-02-1216-50-02.png)

8. Pod Logs contains the logs related to the Pod.j

   ![](/Screenshotfrom2025-02-1216-50-34.png)

9. The Pod Usage panel in DataOS Operations provides insights into the resource consumption of running pods within a namespace. It helps monitor CPU and memory utilization over time, ensuring optimal performance and resource allocation.j

   ![](/Screenshotfrom2025-02-1216-51-09.png)
   ...
   * **Efficient Resource Management**: The panel ensures that pods are operating within assigned CPU and memory limits.

   * **Trend Analysis**: Time series graphs visualize usage patterns, helping identify spikes, bottlenecks, or inefficiencies.

   * **Optimization & Scaling**: Monitoring usage trends enables better resource allocation and scaling decisions.