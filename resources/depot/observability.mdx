...
description: "You can track the status of a Depot—whether it is active or deleted—using the Monitor Resource and Metis UI. Additionally, you can configure Pager Resource to receive notifications if a Depot is deleted."
---
