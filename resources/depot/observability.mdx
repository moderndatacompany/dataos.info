...
description: "DataOS provides a comprehensive set of observability solutions, including the Operations app, Monitor, and Pager, to track the Depot. The Operations app offers real-time insights into performance and resource utilization, while the Monitor enables observation, and the Pager notifies whenever the incident condition is met by the Monitor."
sidebarTitle: "Observability"
---

You can track the status of a Depot—whether it is active or deleted—using the Monitor Resource and Metis UI. Additionally, you can configure Pager Resource to receive notifications if a Depot is deleted.
