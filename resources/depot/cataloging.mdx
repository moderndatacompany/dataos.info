...
Metis has integrated "Depot" as a "Resource type" for storing metadata related to connecting data sources, Compute resources defined for the Depots, connection secrets, and more. On selecting **Depots,** the following information will appear on the screen:j
...
In the card view, click anywhere except the resource name to get the overview.j
...
In the Result or Overview pane, click on the name of the Depot to open the Resource Details page, which includes:j
...
This section provides an overview of the depot's execution history. It offers a concise summary of past runs, allowing users to quickly access information about the depot's previous operations and performance. Click on the link to know more details.j
