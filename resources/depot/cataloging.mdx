...
![Runtime for file based and blob storage depots](https://dataos.info/interfaces/metis/metis_ui_resources/metis_resources_depots/depot_runtime.png)

Runtime for file based and blob storage depots
