...
<AccordionGroup>
  ...
  <Accordion title="MongoDB" defaultOpen={false}>
    ...
    **For certificate authentication:**
    ...
    &#x20;   1\. Initialize the Keystore, remember the password you create while initializing the Keystore.

    &#x20;   2\. Run the following command, to import a certificate (\`demo-ssl-public-cert.cert\`) into the Java KeyStore with the alias (\`moderncert03\`). It will create a keystore and trust store files in the JAVA folder.
