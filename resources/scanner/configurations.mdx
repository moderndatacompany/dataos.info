...
## Manifest file attribute configuration for Monitor Resource
Certain attributes need to be configured within the monitor manifest file, which are as follows: 
...
| **query_constant** | This is a constant value that is added to the product of Query Coefficient and Query. |
