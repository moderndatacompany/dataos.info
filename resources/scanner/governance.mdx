...
description: "An Operator or Administrator of an organization can control who can create, read, update, or delete the Scanner workflow by assigning roles or use cases via Bifrost."
---
...
<Steps>
  <Step title="Navigate to DataOS" titleSize="h2">
