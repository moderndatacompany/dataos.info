...
<Steps>
  <Step title="Step 1: Create a Monitor manifest file for Scanner">
  ...
  <Step title="Step 2: Apply the Monitor manifest file">
  ...
  <Step title="Step 3: Validate runtime of the Monitor">
  ...
  <Step title="Step 4: Create a Pager manifest file for Scanner">
  ...
  <Step title="Step 5: Apply the Pager">
