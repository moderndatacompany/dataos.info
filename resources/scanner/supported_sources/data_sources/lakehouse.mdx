...
sidebarTitle: "Lakehouse"
description: "This section provides a guide and reference for using the Lakehouse metadata Scanner Workflow. It includes configuration steps, and required access permissions for execution."
---
...
* To scan the ⁠Lakehouse (ABFSS, WASBS, GCS, S3) Depot, ensure that the depot is created and  have 

  `read`

   access for the depot. To check the Depot go to the Metis UI of the DataOS or use the following command:
...
* **Access Permissions in DataOS for Lakehouse Scanner Workflow**
