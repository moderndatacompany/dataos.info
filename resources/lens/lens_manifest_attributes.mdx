---
title: "Attribute of Lens manifest file"
...
**Description:** Defines the [Compute](/resources/compute/) Resource to be used by the Lens. The value should match a pre-defined Compute Resource within DataOS that suits the workload requirements of the Lens model.
...
lens:
 source:
  type: themis
  name: minithemis  #name of the cluster in the themis federated query engine
  catalog: lakehouse   #name of the catalog in the minithemis cluster
```
...
| Data Type | Requirement | Default Value | Possible Values                                                      |
| --------- | ----------- | ------------- | -------------------------------------------------------------------- |
| string    | mandatory   | none          | URL of the repository (e.g., https:///mywork15/talos/). |
