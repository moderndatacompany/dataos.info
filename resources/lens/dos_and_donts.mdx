...
* Use only letters, numbers, and underscores (\_); avoid special characters.

* Adopt snake\_case for naming tables, views, measures, and dimensions.
