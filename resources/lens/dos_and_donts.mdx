...
description: "This documentation provides do's and dont's for defining semantic model functionalities, including when to create views and best practices to avoid errors."
---
