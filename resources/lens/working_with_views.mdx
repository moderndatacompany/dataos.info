...
description: "This document explains how to create use Views in Lens to define key metrics on top of the semantic models and define streamline analysis."
sidebarTitle: "Views"
---
...
* **Exploration**: Views can be explored through the Data Product Hub, where the metrics view of the semantic model is populated in the Metrics section of the Data Product Hub powers automated, dynamic dashboards for visualizing and analyzing performance metrics. These dashboards help identify anomalies, uncover trends over time, and provide actionable insights. Additionally, views can be queried directly within the Data Product Hub Studio for deeper analysis.&#x20;
...
<Frame caption="DataOS Home Page">
  <img src="/resources/lens/working_with_views/dph1.png" />
</Frame>
...
<Frame caption="">
  <img src="/resources/lens/working_with_views/dph3.png" />
</Frame>
...
<Frame caption="Data Lineage">
  <img src="/resources/lens/working_with_views/dph4.png" />
</Frame>
...
<Frame caption="Entities and Metrics">
  <img src="/resources/lens/working_with_views/dph5.png" />
</Frame>