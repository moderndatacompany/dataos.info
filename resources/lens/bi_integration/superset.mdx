...
**Step 2 Go to DataOS**: Go to DataOS and select Superset.
   ...
   <div>
      <img src="/resources/lens/bi_integration/superset2.png" alt="Superset Configuration" / >
  </div>

**Step 3 Navigate to Datasets tab:** Here, each entity will appear as a dataset.

   <div>
      <img src="/resources/lens/bi_integration/superset3.png" alt="Superset Configuration" / >
  </div>
