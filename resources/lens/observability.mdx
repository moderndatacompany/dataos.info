---
title: "How to monitor a semantic model"
description: "Utilize different Monitors such as report monitor, equation monitor, etc., to monitor the semantic model or Lens Resource. "
---
...
<Steps>
  <Step title="Create an Monitor to observe the semantic model">
