...
description: "The Operations app in DataOS helps administrators monitor and observe deployed Lens instances, providing real-time insights into performance, user activities, and resource utilization for efficient troubleshooting and analysis."
...
Metric monitoring in Lens is done by Monitor and Pager Resource focuses on tracking the performance and health of the Lens Resources. It helps in measuring key indicators that define the state of the system. A Lens Resource can be monitored using Monitor and Pager Resources. There are two types of Monitors that can be applied to observe the state of deployed Lens and the matrix of the semantic model.
...
Equation Monitor observes the Lens metrics to generate the incidents when the condition meets.
...
<Steps>
  ...
  <Step title="Validate the Monitor">
    ...
    <CodeGroup>
      ...
      ---------------|---------------------------|---------------------------|------------|----------------------------------------------------------------------
        ebctt1wkmsxv | 2025-01-28T18:28:00+05:30 | 2025-01-28T18:28:00+05:30 | completed  | 🟧 monitor condition not met for monitor: 'lens_monitor_curriculum'  
      ---------------|---------------------------|---------------------------|------------|----------------------------------------------------------------------
...
## Observe and Monitor Query Statistics of the Clusters
