...
![](/resources/lens/observability/grafana_5.png)

After completing the configuration, the monitoring dashboard will appear as follows:

![](/resources/lens/observability/grafana_6.png)