...
description: "This document guides you on governing Lens and setting up access control for secure data management. Lens enables user groups to control granular access to the dimension and segments of the semantic model."
