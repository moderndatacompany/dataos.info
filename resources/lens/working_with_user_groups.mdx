...
description: " The Lens enables data security within logical tables by defining data policies on dimensions and segments through user groups. User groups allow the creation of multiple groups with different levels of API scope access. Each group can be tailored to include or exclude specific users based on their access requirements. By defining precise access controls, different levels of data and functionality access can be granted, ensuring that only authorized users interact with relevant resources. "
---
