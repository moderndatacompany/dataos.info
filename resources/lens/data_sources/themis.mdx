...
1. **Access the Themis Cluster**Navigate to the Themis cluster. You should see a screen similar to the image below:<div>
     <img src="/resources/lens/data_sources/Themis/Untitled(7).png" alt="Untitled" />
   </div>

2. **Select the Running Driver**Choose the running driver. **This driver will always be the same, regardless of the user, as queries will be directed to the creator of the Themis cluster**. The running driver remains consistent for all users.<div>
     <img src="/resources/lens/data_sources/Themis/Untitled(9).png" alt="Untitled" />
   </div>
