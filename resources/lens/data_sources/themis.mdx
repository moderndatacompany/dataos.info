...
1. **Select the Running Driver**Choose the running driver. **This driver will always be the same, regardless of the user, as queries will be directed to the creator of the Themis cluster**. The running driver remains consistent for all users.

<div>
  <img src="/resources/lens/data_sources/Themis/Untitled(9).png" alt="Untitled" />
</div>

1. **View the Spark UI**Go to terminal and use the following command to view the spark UI :
