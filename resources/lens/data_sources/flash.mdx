...
This section guides on configuring the Lens using [Flash](/resources/stacks/flash/) [Service](/resources/service/).

<Info>
  Flash is not a DataOS source but is used for query optimization. It is included in the list of DataOS sources&#x20;
</Info>
