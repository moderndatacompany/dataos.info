---
title: "Explore semantic model using GraphQL API"
description: "The following document provides comprehensive instructions for accessing and interacting with the Lens semantic model using GraphQL API."
---

You can interact with the Lens GraphQL API using:
...
**Set the request body in Postman (for POST method):** for `POST` requests, you must configure the Body tab for graphql. Refer to the below image for subsequent steps.
