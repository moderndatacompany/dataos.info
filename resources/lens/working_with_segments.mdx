---
title: "Segments"
description: " The following document will help in defining and applying segments in Lens that can be used during analysis. With segments, users can save time and make complex filtering logic reusable."
