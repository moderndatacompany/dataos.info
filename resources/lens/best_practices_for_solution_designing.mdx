---
title: Best practices for efficient query processing in Lens
description: It outlines the considerations for performing aggregation either in a lakehouse or a data warehouse, depending on the intended architecture and performance goals.
---
