---
title: "How to govern Lens and control access in the semantic model?"
sidebarTitle: "Governance"
description: "The Lens and semantic model access control can be managed through Bifrost. An operator or administrator of an organization can control access to Lens by assigning either roles or use-cases. "
---
