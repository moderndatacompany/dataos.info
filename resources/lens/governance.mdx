...
Data governance in DataOS is structured across four layers to protect and control sensitive information:
...
**Audit logging:** Platforms like Snowflake and BigQuery provide auditing capabilities through their management consoles, allowing administrators to track and log access to sensitive data.

Governance here ensures sensitive data is protected before it moves upstream for further processing, minimizing unauthorized access at later stages.
