---
title: "Explore semantic model using SQL API"
description: "The lens exposes a PostgreSQL-compatible interface, enabling interaction with the semantic model(Lens) using PostgreSQL syntax. The PostgreSQL client tool psql is required to query the database and manage Lens data"
sidebarTitle: "SQL APIs"
---
