...
## Exploring the semantic model and Lens Resource metadata via Metis UI
...
**Search:** Use the search bar to search for specific Lens resources by name, such as `Productaffinity`.
  ...
  ![](/resources/lens/cataloging/image.png)
...
<Frame caption="Search and filter">
  <img src="/resources/lens/cataloging/metis_search.png" />
</Frame>
...
<Frame caption="Advance filter on source">
  <img src="/resources/lens/cataloging/metis_advance_filter.png" />
</Frame>
...
<Frame  caption="Lens listed in the Result pane">
  <img src="/resources/lens/cataloging/result_pane.png" />
</Frame>
...
![](/resources/lens/cataloging/detailed_page_overview.png)
...
## Exploring the semantic model and Lens Resource metadata via Data Product Hub

The Data Product Hub (DPH) plays a key role in cataloging the semantic model of each Data Product. It captures detailed metadata, including the model's source, description, quality metrics, and relevant business context. 
...
1. The Data Product Hub provides a comprehensive view of data lineage in its ‘Overview’ tab. It tracks input datasets, the semantic model, output tables, and derived metrics, showing how tables contribute to specific metrics with visual connections.
   ...
   <Frame caption="Data Product Hub Overview tab showing the overall lineage of the productaffinity Data Product">
     <img src="/resources/lens/cataloging/dph_lineage.png" />
   </Frame>
...
2. In the 'Semantic Model' tab, by default, the lineage of the tables used to create the semantic model and its downstream metric views is displayed. For users who want a deeper understanding, user's can view the full lineage, including the workflows used to derive the semantic model. Additionally, it stores model folder files, enabling developers to explore the model's creation and details.
    ...
    <Frame caption="Data Product Hub Metric tab showing the lineage of the purchase frequency metric">
      <img src="/resources/lens/cataloging/dph_sm_lineage.png" />
    </Frame>
...
3. The 'Metric' tab in the Data Product Hub shows detailed lineage for metrics, highlighting the tables that contributed to each one. For example, the lineage of the `cross_sell_opportunity_score` metric is displayed, showing its derivation from the purchase and product tables. Scrolling down reveals a detailed list of measures and dimensions.
    ...
    <Frame caption="Data Product Hub Metric tab showing the lineage of the purchase frequency metric">
      <img src="/resources/lens/cataloging/dph_metric_lineage.png" />
    </Frame>
