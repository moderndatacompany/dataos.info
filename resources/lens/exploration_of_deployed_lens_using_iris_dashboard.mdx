...
For instance, the following `wallet_sales_view` Iris board shows the weekly performance of revenue and wallet share

![Iris board](https://mintlify.s3.us-west-1.amazonaws.com/dataosinfo/resources/lens/consumption_of_deployed_lens/iris/iris_board.png)
...
<Info>
  When working with the Iris board, ensure that the measures displayed in the view are accurate and relevant. Additionally, make sure to include all the dimensions used in calculating each specific measure. This ensures consistency and provides the necessary context for accurate analysis.
</Info>
...
### **Step 3: Access the Iris board for your Lens via the Data Product Hub**
