---
title: "Semantic modeling concepts"
sidebarTitle: "Concepts"
description: "This document guides on how to create a semantic model using elements such as tables, views, segments, dimensions, and measures. "
---
...
| ------------- | ---------------------------------------------------------------------------------------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `name`        | Unique identifier for the view.                                                                            | ^\[a-zA-Z]\[a-zA-Z0-9\_]\*$ | Use snake\_case. <br /> For example: **`owner_contact_analysis`**                                                   |
