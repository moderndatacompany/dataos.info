...
<Steps>
  <Step title="Push the Lens model directory to a code repository" stepNumber="1">
  ...
  <Step title="Create Instance Secrets for Code Repository Credentials">
  ...
  <Step title="Create a Lens Resource manifest file">
