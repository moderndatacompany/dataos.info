...
<Steps>
  <Step title="Step 1">
    ### ***Push*** **the Lens model directory to a code repository**
  ...
  <Step title="Step 2">
    ### **Create Instance Secrets for Code Repository Credentials**
  ...
  <Step title="Step 4">
    ### **Apply the manifest file of Lens Resource using DataOS CLI**
  ...
  <Step title="Step 5">
    ### **Get the status of created Lens**
