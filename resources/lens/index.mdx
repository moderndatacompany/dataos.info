...
<AccordionGroup>
      ...
      <Tab title="PowerBI">
        <Tabs>
          ...
          <Tab title="Using Data Product Hub">
            Here, it is assumed that you are aware of the data product on which your semantic model is built.
  ...
  <Accordion title="GraphQL" defaultOpen={false}>
    ...
    <Tabs>
      ...
      <Tab title="Curl">
        * **Curl** – A command-line tool for making API requests, useful for automation and scripting.
    ...
    <Tabs>
      <Tab title="Using CLI">
        To create the dataos user apikey follow the below steps:
      </Tab>
