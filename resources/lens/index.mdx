...
* [Data modelling concepts](/resources/lens/concepts/): Understand the core principles and methodologies essential for designing effective data models.
...
A Lens Resource can be monitored using Monitor and Pager resources. To learn how to create and configure these monitors, click [here](/resources/lens/observability).
