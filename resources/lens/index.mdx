    ...
    <Tabs>
      <Tab title="Using CLI">
        ...
        * **DataOS API key**: Ensure the DataOS API key is available. Get it by using the following command:
        ...
        | Measure   | avg       | Not Supported              | Option 1: To use measure of type ‘avg’, define an additional measure of type 'count' in that entity:                                                                             name: count&#xA;type: count&#xA;sql: '1'.                                                                                                Option 2: Use measure of type 'number' and define average logic in SQL:                                                                                             |
        |           |           |                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |

        Option 2: Use measure of type 'number' and define average logic in SQL: |
      </Tab>
