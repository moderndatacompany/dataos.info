...
3. **Set the Request type:** Select the API request type as `POST` from the dropdown next to the API URL.

4. **Prepare the URL and Query the API:**  Prepare the URL according to what data you want to fetch.
...
[](https://dataos.info/resources/lens/exploration_of_deployed_lens_using_graphql/#__codelineno-18-1)
...
[](https://dataos.info/resources/lens/exploration_of_deployed_lens_using_graphql/#__codelineno-25-1)Any supported granularity can be used. If you prefer to not specify a granularity, then use `value`:
...
[](https://dataos.info/resources/lens/exploration_of_deployed_lens_using_graphql/#__codelineno-26-1)**Specifying order by condition and limiting the result**
