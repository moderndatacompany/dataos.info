...
| Key     | Schema            | Description                                                                                                                                                                                                                    |
| ------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| where   | TableWhereInput   | The Where clause conditions specify the logical operators and filters you can use inside the where argument to refine your query. It uses logical operators like `AND`, `OR`  and to filter the specific table member filters. |
