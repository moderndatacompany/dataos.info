...
5. Once connected, hover over the postgres folder and click the terminal icon to open the terminal for querying.

6. Execute [commands](#commands) in the terminal as needed.
