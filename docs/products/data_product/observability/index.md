...
This section describes how users can view the [status](/products/data_product/observability/key_concepts/#status) and [runtime](/products/data_product/observability/key_concepts/#runtime) of DataOS Resources through the DataOS CLI, Metis Catalog, or Operations App. 
