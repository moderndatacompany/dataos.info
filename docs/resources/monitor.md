...
A Monitor in DataOS takes [*metrics*](#key-concepts-of-monitor) and [*events*](#key-concepts-of-monitor) as input and generates [incidents](#key-concepts-of-monitor) as output. 
