...
* [Using Data Product Hub(Recommended - GUI based)](/resources/lens/bi_integration/superset/#using-data-product-hubrecommended): This method provides a user-friendly, graphical interface for integrating the semantic model with Superset.  This approach is ideal for those who prefer an intuitive, no-code setup.
