...
service:
  ...
  stack: beacon+rest
  envs:
    PGRST_OPENAPI_SERVER_PROXY_URI: https://<dataos-context>/order-summary/api/v1/order-summary/api/v1
  beacon:
    source:
      type: database
      name: ordersumdb
...
[https://touched-rattler.dataos.app/order-summary/api/v1/order_summary_search](https://touched-rattler.dataos.app/order-summary/api/v1/order_summary_search)

[https://touched-rattler.dataos.app/order-summary/api/v1/order_summary_search?document_vectors=phfts(english).{0](https://touched-rattler.dataos.app/order-summary/api/v1/order_summary_search?document_vectors=phfts(english).%7B0)}
...
[https://touched-rattler.dataos.app/decision_product/](https://touched-rattler.dataos.app/decision_product/)