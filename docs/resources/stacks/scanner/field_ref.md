...
> Filter patterns support Regex in `includes` and `excludes` expressions. Refer to [Filter Pattern Examples](/resources/sstacks/scanner/creating_scanner_workflows/filter_pattern_examples)  page for the example scenarios.
