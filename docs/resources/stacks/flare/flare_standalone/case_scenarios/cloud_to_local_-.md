...
You can check out the [Standalone YAML configuration section](../Standalone%20YAML%20Configurations%20949cc395e0d347e59b0649206fcd4052.md) for other inputs and outputs data sources.
...
1. The last and final aspect that's missing is the `serviceUrl` and `adminUrl`, for which you require two things 
    ...
    [Getting the Port of ServiceUrl and AdminUrl](Cloud%20to%20Local%20-%20Using%20Standalone%202%200%2090147e1d6ac64e11b9ce94f3002a2e3c/Getting%20the%20Port%20of%20ServiceUrl%20and%20AdminUrl%20c58ecfa2508f4ee89950c2cbab0c2e53.md)
