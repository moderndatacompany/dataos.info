...
## Your first assignment[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#your-first-assignment)
...
On the left-hand side of the assignment is our assignment target, where `root` is a keyword referring to the root of the new document being constructed. On the right-hand side is a query that determines the value to be assigned, where `this` is a keyword that refers to the context of the mapping, which begins as the root of the input document.
...
## Basic Methods and Functions[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#basic-methods-and-functions)
...
### Deletions[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#deletions)
...
## Variables[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#variables)
...
## Unstructured and Binary Data[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#unstructured-and-binary-data)
...
## Conditionals[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#conditionals)
...
### If Expression[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#if-expression)
...
### Match Expression[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#match-expression)
...
## Error Handling[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#error-handling)
...
## Validation[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#validation)
...
## Context[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#context)
...
### Naming the Context[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#naming-the-context)
...
## Coalescing[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#coalescing)
...
## Advanced Methods[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#advanced-methods)
...
Let's say we wanted to reduce the `things` in our input document to only those that are cool and where we have enough of them to share with our friends. We can do this with a `[filter` method](https://www.benthos.dev/docs/guides/bloblang/methods#filter):
...
Another such method is `[map_each](https://www.benthos.dev/docs/guides/bloblang/methods#map_each)`, which allows you to mutate each element of an array, or each value of an object. Change your input document to the following:
...
Here we have an array of talking heads, where each element is a string containing an identifier, a colon, and a comma-separated list of their opinions. We wish to map each string into a structured object, which we can do with the following mapping:
...
## Reusable Mappings[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#reusable-mappings)
...
Named maps are executed with the method `[apply](https://www.benthos.dev/docs/guides/bloblang/methods#apply)`, which has a string parameter identifying the map to execute, this means it's possible to dynamically select the target map.
...
## Unit Testing[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#unit-testing)
...
## Final Words[](https://www.benthos.dev/docs/guides/bloblang/walkthrough/#final-words)
