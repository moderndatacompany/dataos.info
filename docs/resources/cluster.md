...
A Compute Resource can be provisioned [on-demand](./cluster/on_demand_computing.md), allowing for efficient allocation of resources based on workload-specific requirements. This decoupling of computation and storage, facilitates flexibility and scalability.
...
Minerva supports an extensive range of data sources, encompassing both traditional relational databases such as Oracle, PostgreSQL, MySQL, and Redshift, non-relational sources like Kafka and Cassandra, as well as object storages like Amazon S3, and Google Cloud Storage. This broad compatibility ensures seamless access to various data sources, enabling comprehensive and integrated analyses.

#### **Query Execution Process**

When initiating a SQL query from sources such as Workbench, Atlas, Minerva-CLI, JDBC, or Lens, the query is seamlessly directed to the Minerva Gateway Service. The Gateway Service conducts a thorough analysis of the query and the associated tables, forwarding it to the Minerva Clusters for execution. Furthermore, the Gateway Service facilitates data policy decisions, including Masking and Filtering policies. Once the analysis is completed, the query is seamlessly passed on to the Minerva Cluster for execution.
...
| [`selector`](./cluster/cluster_grammar.md#selector) | string | none | query-default or any other custom compute resource | mandatory |
| [`users`](./cluster/cluster_grammar.md#users) | string | none | none | optional |
| [`sources`](./cluster/cluster_grammar.md#sources) | object | none | none | optional |
| [`replicas`](./cluster/cluster_grammar.md#replicas) | string | none | any valid cron expression | optional |
| [`match`](./cluster/cluster_grammar.md#match) | object | none | none | optional |
| [`priority`](./cluster/cluster_grammar.md#priority) | string | none | any valid cron expression | optional |
| [`runAsApiKey`](./cluster/cluster_grammar.md#runasapikey) | integer | 1 | positive integer | optional |
| [`runAsUser`](./cluster/cluster_grammar.md#runasuser) | object | none | none | optional |
| [`resources`](./cluster/cluster_grammar.md#resources) | object | none | none | optional |
| [`limits`](./cluster/cluster_grammar.md#limits) | object | none | none | optional |
| [`cpu`](./cluster/cluster_grammar.md#cpu) | string | requests: 100m, limits: 400m | number of cpu units in milliCPU(m) or cpu Core| optional |
| [`memory`](./cluster/cluster_grammar.md#memory) | string | requests: 100Mi, limits: 400Mi | memory in Mebibytes(Mi) or Gibibytes(Gi) | optional |
| [`requests`](./cluster/cluster_grammar.md#requests) | object | none | none | optional |
| [`debug`](./cluster/cluster_grammar.md#debug) | object | none | none | optional |
| [`logLevel`](./cluster/cluster_grammar.md#loglevel) | object | none | none | optional |
| [`trinoLogLevel`](./cluster/cluster_grammar.md#trinologlevel) | object | none | none | optional |
| [`depots`](./cluster/cluster_grammar.md#depots) | object | none | none | optional |
| [`address`](./cluster/cluster_grammar.md#address) | object | none | none | optional |
| [`properties`](./cluster/cluster_grammar.md#properties) | object | none | none | optional |
| [`catalogs`](./cluster/cluster_grammar.md#catalogs) | object | none | none | optional |
| [`name`](./cluster/cluster_grammar.md#name) | object | none | none | optional |
| [`type`](./cluster/cluster_grammar.md#type) | object | none | none | optional |
| [`properties`](./cluster/cluster_grammar.md#properties-1) | object | none | none | optional |
