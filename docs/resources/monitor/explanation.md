...
Monitor Service is responsible for cross-checking the [condition](https://dataos.info/resources/monitor/#key-concepts-of-monitor) declared by the user with an Event/Metric generated in the system. If the condition is fulfilled, it publishes the information mentioned in the manifest file as an [incident](https://dataos.info/resources/monitor/#key-concepts-of-monitor) to a [Fastbase](https://dataos.info/resources/depot/fastbase/) topic. This Fastbase topic is a store based on the Pulsar DB system.
