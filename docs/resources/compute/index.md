...
In DataOS, a Compute is classified as a [Resource-type.](/resources/types_of_dataos_resources) Below is the YAML configuration for the Resource Section:
```yaml
name: ${{my-workflow}}
version: v1 
type: workflow 
...
For detailed customization options and additional attributes within the Resource Section, refer to the [Attributes of Resource section.](/resources/resource_attributes).
