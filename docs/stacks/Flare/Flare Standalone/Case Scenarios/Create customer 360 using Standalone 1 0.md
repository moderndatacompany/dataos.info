...
After you have successfully installed Flare and run the sample workflow, you are ready to dive into the assignment and achieve a Customer 360 with guided steps. If you don’t know how to get the Flare Standalone running, refer to
[Flare Standalone](../Case%20Scenarios.md)
...
<img src="Create%20customer%20360%20using%20Standalone%201%200/C360-diagram-new2.png"
        alt="Flow diagram explaining data transformations in Flare standalone achieving Customer 360."
        style="display: block; margin: auto" />

<figcaption align = "center">Flow diagram explaining data transformations in Flare standalone achieving Customer 360.</figcaption>
<br>
...
1. Download the `assignment.zip` given below
  [assignment.zip](Create%20customer%20360%20using%20Standalone%201%200/assignment.zip).
...
1. Extract the assignment zip file. This file contains the following:
    ...
    <img src="Create%20customer%20360%20using%20Standalone%201%200/assignment_data_folder.png"
        alt="assignment data folder.png"
        style="display: block; margin: auto" />
...
3. You can run the `tables` **command in Scala interactive shell to check the created tables.
