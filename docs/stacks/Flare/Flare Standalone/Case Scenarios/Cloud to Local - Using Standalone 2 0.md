...
You can check out the [Standalone YAML configuration section](../Standalone%20YAML%20Configurations.md) for other inputs and outputs data sources.
...
1. The last and final aspect that's missing is the `serviceUrl` and `adminUrl`, for which you require two things 
    ...
    [Getting the Port of ServiceUrl and AdminUrl](Cloud%20to%20Local%20-%20Using%20Standalone%202%200/Getting%20the%20Port%20of%20ServiceUrl%20and%20AdminUrl%20b0396ba4d8d54a1f83dd3c6ea4b6435e.md).
