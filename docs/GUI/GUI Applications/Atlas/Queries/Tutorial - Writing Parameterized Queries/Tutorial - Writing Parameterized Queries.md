# Tutorial - Writing Parameterized Queries
...
![Query output for multiple values selected from the dropdown](./Tutorial%20-%20Writing%20Parameterized%20Queries/query_based_multi.png)
